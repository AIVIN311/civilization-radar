...
This file is the central index for project documentation.
...
- `.github/ISSUE_TEMPLATE/agent-task-md.md`
- `.github/ISSUE_TEMPLATE/radar-bug-md.md`
- `.github/ISSUE_TEMPLATE/research-proposal-md.md`
- `.github/instructions/_instructions.md`
